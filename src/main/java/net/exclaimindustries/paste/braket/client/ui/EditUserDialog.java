...
public class EditUserDialog extends SimpleLayoutPanel {
    ...
    public EditUserDialog() {
        ...
        Column<BraketUser, String> firstNameColumn =
                addColumn(new EditTextCell(), "first name",
                        new GetValue<String>() {
                            @Override
                            ...
                            @Override
                            public void update(int index, BraketUser object,
                                    String value) {
                                UserName name = object.getName();
                                UserName newName =
                                        new UserName(value, name.getLastName(),
                                                name.getNickname());
        ...
        Column<BraketUser, String> lastNameColumn =
                addColumn(new EditTextCell(), "last name",
                        new GetValue<String>() {
                            @Override
                            public String getValue(BraketUser user) {
        ...
        Column<BraketUser, String> nicknameColumn =
                addColumn(new EditTextCell(), "nickname",
                        new GetValue<String>() {
                            @Override
                            public String getValue(BraketUser user) {
                            ...
                            public void update(int index, BraketUser object,
                                ...
                                UserName name = object.getName();
                                UserName newName =
                                        new UserName(name.getFirstName(), name
                                                .getLastName(), value);
                                object.setName(newName);
                                doUserUpdate(index, object);
                            }
...
//        pager.setDisplay(dataGrid);
     ...
     */
    private <C> Column<BraketUser, C> addColumn(Cell<C> cell,
            String headerText, final GetValue<C> getter,
            FieldUpdater<BraketUser, C> fieldUpdater) {
