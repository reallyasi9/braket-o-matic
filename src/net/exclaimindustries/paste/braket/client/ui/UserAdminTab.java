...
import net.exclaimindustries.paste.braket.client.UserServiceAsync;
...
public class UserAdminTab extends Composite {

	private static UserAdminTabUiBinder uiBinder = GWT
			.create(UserAdminTabUiBinder.class);

	interface UserAdminTabUiBinder extends UiBinder<Widget, UserAdminTab> {
	}
//
...
//
//		@Override
//		protected void onRangeChanged(HasData<BraketUser> display) {
...
//			userService.getUsers(sortCondition, offset, limit,
...
//	public UserAdminTab() {
//
//		dataGrid = new DataGrid<BraketUser>(20,
//				BraketUser.KEY_PROVIDER);
//
//		// Create columns
