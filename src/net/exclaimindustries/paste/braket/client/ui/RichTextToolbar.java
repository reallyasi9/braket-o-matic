...
public class RichTextToolbar extends Composite {
    ...
    private Resources images = (Resources) GWT.create(Resources.class);
    ...
    public RichTextToolbar(RichTextArea richText) {
        ...
        if (basic != null) {
            ...
            topPanel.add(underline =
                    createToggleButton(images.underline(), "underline"));
            topPanel.add(subscript =
                    createToggleButton(images.subscript(), "subscript"));
            topPanel.add(superscript =
                    createToggleButton(images.superscript(), "superscript"));
            topPanel.add(justifyLeft =
                    createPushButton(images.justifyLeft(), "justifyLeft"));
            topPanel.add(justifyCenter =
                    createPushButton(images.justifyCenter(), "justifyCenter"));
            topPanel.add(justifyRight =
                    createPushButton(images.justifyRight(), "justifyRight"));
        }

        if (extended != null) {
            topPanel.add(strikethrough =
                    createToggleButton(images.strikeThrough(), "strikeThrough"));
            topPanel.add(indent = createPushButton(images.indent(), "indent"));
            topPanel.add(outdent =
                    createPushButton(images.outdent(), "outdent"));
            ...
            topPanel.add(insertImage =
                    createPushButton(images.insertImage(), "insertImage"));
            topPanel.add(createLink =
                    createPushButton(images.createLink(), "createLink"));
            topPanel.add(removeLink =
                    createPushButton(images.removeLink(), "removeLink"));
            topPanel.add(removeFormat =
                    createPushButton(images.removeFormat(), "removeFormat"));
        }
