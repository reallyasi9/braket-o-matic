...
public class BackendAdminTab extends Composite {

    private static BackendAdminTabUiBinder uiBinder = GWT
            .create(BackendAdminTabUiBinder.class);

    interface BackendAdminTabUiBinder extends
            UiBinder<Widget, BackendAdminTab> {
    }
